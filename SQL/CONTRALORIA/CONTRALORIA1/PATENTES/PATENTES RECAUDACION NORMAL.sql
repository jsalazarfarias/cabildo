select emi01codi num_titulo, to_number(to_char(emi01fpag,'rrrr')) anio_recaudacion, emi01anio anio_titulo,gen01codi ciu, pk_uti.gen01_com(gen01codi) contribuyente, 
...
(emi01vtot + emi01inte + emi01reca + emi01coa) - emi01desc valor_titulo, emi01femi fecha_emisiom, emi01lcre usario,(select seg03com from st_seg03 a where a.seg03codi = emi01.EMI01LCRE) funcionario_emite,
