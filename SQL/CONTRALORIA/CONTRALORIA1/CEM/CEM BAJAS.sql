...
((nvl(emi01vtot,0) + nvl(emi01inte,0) + nvl(emi01reca,0) + nvl(emi01coa,0)) - nvl(emi01desc,0)) valor_TITULO, emi01femi fecha_emisiom, emi01lcre usario,(select seg03com from st_seg03 a where a.seg03codi = emi01.EMI01LCRE) funcionario_emite,
