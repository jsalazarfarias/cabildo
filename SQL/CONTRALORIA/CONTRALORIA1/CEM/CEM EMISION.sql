select emi01codi num_titulo, to_number(to_char(EMI01FCRE,'rrrr')) anio_EMITE, emi01anio anio_titulo ,gen01codi ciu, pk_uti.gen01_com(gen01codi) contribuyente, 
...
0 emi01inte,  0 emi01reca, 0 emi01coa, 0 emi01desc, 
((emi01vtot + 0 + 0 + 0) - 0) valor_TITULO, emi01femi fecha_emisiom, emi01lcre usario,(select seg03com from st_seg03 a where a.seg03codi = emi01.EMI01LCRE) funcionario_emite,
...
and nvl((select emi02vdet 
                            from emi02 b
                            where b.emi01codi = emi01.emi01codi
                            and emi04codi = 510),0) > 0
