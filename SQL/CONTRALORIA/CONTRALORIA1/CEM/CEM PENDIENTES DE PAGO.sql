...
web_interes(emi01codi) as emi01inte,  web_recargo(emi01codi) as emi01reca, web_coactiva(emi01codi) as emi01coa, emi01desc, 
((nvl(emi01vtot,0) + web_interes(emi01codi) + web_recargo(emi01codi) + web_coactiva(emi01codi)) - nvl(emi01desc,0)) valor_TITULO, emi01femi fecha_emisiom, emi01lcre usario,(select seg03com from st_seg03 a where a.seg03codi = emi01.EMI01LCRE) funcionario_emite,
...
and emi01anio in ('2019', '2020','2021','2022','2023') AND EMI01ESTA = 'B')
GROUP BY EMI04CODI)
